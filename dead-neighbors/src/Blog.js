    ...
    <div className = 'blog' style={{ marginTop: "150px" }}>
      ...
      <h2>Blog 1 MM-DD-YYYY</h2>
        <p>
          ...
          proident cupidatat.Cupidatat cillum occaecat deserunt aliqua. Esse eu
          enim incididunt ea anim nostrud elit ut qui aliquip officia proident
        ...
        <p>
          ...
          anim nostrud elit ut qui aliquip officia proident cupidatat.Cupidatat
          cillum occaecat deserunt aliqua. Esse eu enim incididunt ea anim
          nostrud elit ut qui aliquip officia proident cupidatat.Cupidatat
          cillum occaecat deserunt aliqua. Esse eu enim incididunt ea anim
          nostrud elit ut qui aliquip officia proident cupidatat.Cupidatat
          cillum occaecat deserunt aliqua.
        </p>
        <p>
          Esse eu enim incididunt ea anim nostrud elit ut qui aliquip officia
          proident cupidatat.Cupidatat cillum occaecat deserunt aliqua. Esse eu
