  ...
  return (
    <div className="resources">
      ...
      <div className="infoCard cdc">
        ...
        >
          <button>
            <div className="click-me">Centers for Disease Control</div>
          </button>
        </a>
      </div>
      <div className="infoCard who">
        ...
        <img
          src={WHO}
          alt="World Health Organization Teaching Class Awareness"
        />
        <a
          target="_blank"
          rel="nofollow noopener noreferrer"
        ...
        >
          <button>
            <div className="click-me">World Heath Organization</div>
          </button>
        </a>
      </div>
      <div className="infoCard nih">
        ...
        >
          <button>
            <div className="click-me">National Institutes of Health</div>
          </button>
        </a>
      </div>
    </div>
